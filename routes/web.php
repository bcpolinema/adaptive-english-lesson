...
Route::group(['prefix' => 'a', 'middleware' => ['admin', 'auth', 'pvb']], function () {
    ...
    Route::delete('delete-subject', [AdminController::class, 'deleteSubject']);
    // Exercise
    ...
    Route::delete('delete-exercise', [AdminController::class, 'deleteExercise']);
    // Student Exercise
    ...
    Route::delete('delete-std-exercise', [AdminController::class, 'deleteStdExercise']);
    // Student Learning
    ...
    Route::delete('delete-std-learning', [AdminController::class, 'deleteStdLearning']);
