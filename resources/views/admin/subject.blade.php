...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <br>
                <form id="add_subject" action="{{route('admin.add.subject')}}" method="POST" class="form-label-left input_mask">
                    @csrf
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#edit_subject_btn', function() {
            ...
            $.post(url, {
                ...
                $('.edit_subject_modal').find('input[name="description"]').val(data.details.description);
