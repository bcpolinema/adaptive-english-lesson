...
-->
    ...
    <link rel="stylesheet" href="{{ asset('landing-page-v1/assets/css/templatemo-chain-app-dev.css') }}">
    <link rel="stylesheet" href="{{ asset('landing-page-v1/assets/css/animated.css') }}">
    <link rel="stylesheet" href="{{ asset('landing-page-v1/assets/css/owl.css') }}">
...
<body>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            @auth
                            <li>
                                <div class="gradient-button"><a id="modal_trigger" href="{{ route('login') }}">Dashboard
    ...
    <div id="modal" class="popupContainer" style="display:none;">
        <div class="popupHeader">
            ...
            <span class="modal_close"><i class="fa fa-times" style="color:black"></i></span>
        </div>
        ...
        <section class="popupBody">
            ...
            <div class="social_login">
                <div>
                    <img src="{{ asset('landing-page-v1/assets/images/login-logo.png') }}" alt="Chain App Dev">
                </div>
                <br><br>
                    ...
                    <div class="row">
                        <div class="col-lg-6 align-self-center">
                            <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h2>Adaptive English Learning</h2>
                                        <p>Aplikasi Pembelejaran Bahasa Inggris dengan Model Adaptive Learning,
                                            Politeknik Negeri Malang</p>
                                    </div>
                                    <br><br>
                                    <div class="col-lg-12">
                                        <div class="white-button first-button scroll-to-section">
                                            <a href="#!">Basic Learning</a>
                                        </div>
                                        <div class="white-button scroll-to-section">
                                            <a href="#!">Advanced Learning</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                                <img src="{{ asset('landing-page-v1/assets/images/login-logo.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="section-heading  wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.5s">
                        ...
                        <p>Kembangkan skill bahasa inggris mu dengan mempelejari berbagai topic pada setiap section
                            dibawah ini
                            dengan level sebagai penentu skill bahasa inggrismu.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <!-- Scripts -->
    <script src="{{ asset('landing-page-v1/vendor/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('landing-page-v1/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('landing-page-v1/assets/js/owl-carousel.js') }}"></script>
    <script src="{{ asset('landing-page-v1/assets/js/animation.js') }}"></script>
    <script src="{{ asset('landing-page-v1/assets/js/imagesloaded.js') }}"></script>
    <script src="{{ asset('landing-page-v1/assets/js/popup.js') }}"></script>
    <script src="{{ asset('landing-page-v1/assets/js/custom.js') }}"></script>
